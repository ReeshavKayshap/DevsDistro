...
export default function SellerDashboardPage({
  ...
  return (
    <div className="h-screen flex transition-colors duration-300 relative overflow-hidden bg-background text-foreground dark:text-foreground dark:bg-background">
      <SEO
